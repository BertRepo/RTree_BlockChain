...
# def plot_results(search_time_all_bm_tree, search_time_all_mk_tree, search_time_all_gb_tree, num_transactions,
...
#         # plt.plot(block_height_list, search_time_all_bm_tree, label='BM树查找时间', marker='o')
...
#         # plt.plot(num_transactions_list, search_time_all_bm_tree, label='BM树查找时间', marker='o')
